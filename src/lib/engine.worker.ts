...
self.onmessage = async (e: MessageEvent<{ id: number, fen?: string, depth?: number, isPonder?: boolean, type: 'start', isPonderingAnimationEnabled?: boolean }>) => {
    const { id, fen, depth, isPonder, isPonderingAnimationEnabled } = e.data;
